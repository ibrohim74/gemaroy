    ...
    return (
        <div className={'s5 container'} id={'fikir'}>
            <div className="s5-info">
                <div className="s5-left wow animate__animated animate__fadeInUp"><img src={require('../assets/img/s5/s5.png')} alt=""/></div>
                <div className="s5-right wow animate__animated animate__fadeInUp">
            ...
            <div className="s5-video">
                ...
                <div className="s5-video-box">
                    <div className="s5-video-item wow animate__animated animate__fadeInUp">
